      ...
      for(TDno in 1){
        ObsOrTD <- TDnos[TDno]
          ...
          print(paste(RepNum,ObsOrTD,t_choice,Percent))
            ...
            dat_path <- file.path(origin,"_2021","data","_runs",paste0("Rep_",RepNum),t_choice,paste0("p_",Percent),ObsOrTD,"data","traitInfoTD_pred_zlog.csv")
            ...
            if(!file.exists(file.path(origin,"_2021","data","analyses","PCA",t_choice,ObsOrTD,GapPercent1))){
              dir.create(file.path(origin,"_2021","data","analyses","PCA",t_choice,ObsOrTD,GapPercent1))}
            if(!file.exists(file.path(origin,"_2021","data","analyses","PCA",t_choice,ObsOrTD,GapPercent1,RepNum))){
              dir.create(file.path(origin,"_2021","data","analyses","PCA",t_choice,ObsOrTD,GapPercent1,RepNum))}
            print(GapPercent1)
            write.table(pca_out,file= 
                          file.path(origin,"_2021","data","analyses","PCA",t_choice,ObsOrTD,GapPercent1,RepNum,paste0("PCA.csv")),
