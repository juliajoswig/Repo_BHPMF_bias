...
ObsOrTD="Obs_obs_TD"
Percent=80
res <- read.csv(file.path(origin,"_2021","data","analyses","Point_wise",RepNum,t_choice,ObsOrTD,Percent,paste0("res_2021_08.csv")))


ObsOrTD="Obs_obs"
Percent=80
resENV <- read.csv(file.path(origin,"_2021","data","analyses","Point_wise",RepNum,t_choice,ObsOrTD,Percent,paste0("res_2021_08.csv")))
