...
{
  if(t_choice=="data"){
    pdf(file=file.path(origin,"_2021","figures","Figure_4","Figure_SpiderTraitWise.pdf"),width = 8,height=11)
  }
  if(t_choice=="data_2"){
    pdf(file=file.path(origin,"_2021","figures","Figure_4","Figure_S_SpiderTD2TraitWise.pdf"),width = 8,height=11)}
...
pdf(file=file.path(origin,"_2021","figures","Figure_6","Figure_6_SpiderExplain.pdf"),width = 18,height=6)
  ...
  radarchart(data_chart,pcol = colz_solid,cglty = 1, 
             cglwd = 2,axistype = 3,plty = c(1,1,1,1),plwd = c(20,8,8,8),pty = 16,
             axislabcol = "black",
             #  pfcol = c(colz_alpha[2],NA,NA),
...
#                             "dist(x,lm(LeP))")
  ...
  legend(0.5,10,legend = c("TD","TD_td","TD_ext"),col=colz_solid[1:3],lwd=8,lty=1,bty="n",cex=3)
