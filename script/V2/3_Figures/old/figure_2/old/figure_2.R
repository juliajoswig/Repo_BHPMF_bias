...
# Sil along gap size
#--------------------------------------
pdf(file=file.path(origin,"figures","figure_2","figure_2_a.pdf"),width=12,height=6)
par(mfrow=c(2,4),mar=c(4,4,2,2))
i=2

  plot(dat_plot[dat_plot[,1]!=(-1),c(1,i)],col=colz1[5],pch=16,cex.lab=cxlab,
       main=colnames(dat_plot)[i],xlab="% Gaps",ylab="Silhouette index",xlim=c(0,72),ylim=c(-.5,.2))
  rect(xleft=-10, ybottom=dat_plot[dat_plot[,1]==(-1),i], xright=80, ytop=.5, density = NULL, angle = 45,
       border = "white",col=colup)
  rect(xleft=-10, ybottom=-.6, xright=80, ytop=dat_plot[dat_plot[,1]==(-1),i], density = NULL, angle = 45,
       border = "white",col=coldown)
  abline(h=seq(-1.2,1.2,by=.2),col="gray",lty=2)
  abline(h=dat_plot[dat_plot[,1]==(-1),c(1,i)],col=colz1[5],lwd=2)
  points(dat_plot[dat_plot[,1]!=(-1),c(1,i)],col=colz1[5],pch=16,
         main=colnames(dat_plot)[i],xlab="% Gaps",ylab="Silhouette index",xlim=c(0,72),ylim=c(-.5,.2))
  lines(dat_plot[,c(1,i)][order(dat_plot[,1]),],col="black",lwd=3.5)
  lines(dat_plot[,c(1,i)][order(dat_plot[,1]),],col=colz1[5],lwd=3)
  
dev.off()


pdf(file=file.path(origin,"figures","figure_2","figure_2_b.pdf"),width=12,height=6)
par(mfrow=c(2,4),mar=c(4,4,2,2))
i=2
...
for(i in 2:5){
  ...
  rect(xleft=-10, ybottom=-.6, xright=80, ytop=dat_plot2[dat_plot2[,1]==(-1),i], density = NULL, angle = 45,
       border = "white",col=coldown)
  abline(h=seq(-1.2,1.2,by=.2),col="gray",lty=2)
  abline(h=dat_plot2[dat_plot2[,1]==(-1),c(1,i)],col=colz2[5],lwd=2)
...
pdf(file=file.path(origin,"figures","figure_2","figure_2_c.pdf"),width=12,height=6)
par(mfrow=c(2,6),mar=c(5,5,2,2))
i=2
groups=c(NA,"Species","Genera","Families","Phylo groups","Growth forms","PFTs")
for(i in 2:7){
  nm_now=groups[i]
  plot(dat_plot[dat_plot[,1]!=(-1),c(1,i)],col=colz1[5],pch=16,cex.lab=cxlab,cex.main=cxlab,
       main=nm_now,xlab="% Gaps",ylab="Silhouette index",xlim=c(0,72),ylim=c(-.5,.2))
  rect(xleft=-10, ybottom=dat_plot[dat_plot[,1]==(-1),i], xright=80, ytop=.5, density = NULL, angle = 45,
       border = "white",col=colup)
  rect(xleft=-10, ybottom=-.6, xright=80, ytop=dat_plot[dat_plot[,1]==(-1),i], density = NULL, angle = 45,
       border = "white",col=coldown)
  ...
  points(dat_plot[dat_plot[,1]!=(-1),c(1,i)],col=colz1[5],pch=16,
         main=colnames(dat_plot)[i],xlab="% Gaps",ylab="Silhouette index",xlim=c(0,72),ylim=c(-.5,.2))
  lines(dat_plot[,c(1,i)][order(dat_plot[,1]),],col="black",lwd=3.5)
  lines(dat_plot[,c(1,i)][order(dat_plot[,1]),],col="white",lwd=3)
  lines(dat_plot[,c(1,i)][order(dat_plot[,1]),],col=colz1[5],lwd=3)
}
...
for(i in 2:7){
  nm_now=groups[i]
  plot(dat_plot2[dat_plot2[,1]!=(-1),c(1,i)],col=colz2[5],pch=16,cex.lab=cxlab,cex.main=cxlab,
       main=nm_now,xlab="% Gaps",ylab="Silhouette index",xlim=c(0,72),ylim=c(-.5,.2))
  rect(xleft=-10, ybottom=dat_plot2[dat_plot2[,1]==(-1),i], xright=80, ytop=.5, density = NULL, angle = 45,
       border = "white",col=colup)
  rect(xleft=-10, ybottom=-.6, xright=80, ytop=dat_plot2[dat_plot2[,1]==(-1),i], density = NULL, angle = 45,
  ...
  points(dat_plot2[dat_plot2[,1]!=(-1),c(1,i)],col=colz2[5],pch=16,
         main=colnames(dat_plot2)[i],xlab="% Gaps",ylab="Silhouette index",xlim=c(0,72),ylim=c(-.5,.2))
  lines(dat_plot2[,c(1,i)][order(dat_plot2[,1]),],col="black",lwd=3.5)
  lines(dat_plot2[,c(1,i)][order(dat_plot2[,1]),],col="white",lwd=3)
  lines(dat_plot2[,c(1,i)][order(dat_plot2[,1]),],col=colz2[5],lwd=3)
}
dev.off()
}
...
pdf(file=file.path(origin,"figures","figure_2","figure_2_d.pdf"),width=12,height=6)
par(mfrow=c(2,6),mar=c(4,4,2,2))
i=2

for(i in 2:7){
  plot(dat_plot[dat_plot[,1]!=(-1),c(1,i)],col=colz1[5],pch=16,
       main=colnames(dat_plot)[i],xlab="% Gaps",ylab="Silhouette index",xlim=c(0,72),ylim=c(0.1,1.1))
  rect(xleft=-1, ybottom=dat_plot[dat_plot[,1]==(-1),i], xright=80, ytop=3, density = NULL, angle = 45,
       border = "white",col=colup)
  rect(xleft=-1, ybottom=-2, xright=80, ytop=dat_plot[dat_plot[,1]==(-1),i], density = NULL, angle = 45,
       border = "white",col=coldown)
  abline(h=seq(-1.2,2,by=.2),col="gray",lty=2)
  abline(h=dat_plot[dat_plot[,1]==(-1),i],col=colz1[5],lwd=2)
  points(dat_plot[dat_plot[,1]!=(-1),c(1,i)],col=colz1[5],pch=16,
         main=colnames(dat_plot)[i],xlab="% Gaps",ylab="Silhouette index",xlim=c(0,72),ylim=c(-.5,.2))
  lines(dat_plot[,c(1,i)][order(dat_plot[,1]),],col="black",lwd=3.5)
  lines(dat_plot[,c(1,i)][order(dat_plot[,1]),],col=colz1[5],lwd=3)
...
for(i in 2:7){
  ...
  rect(xleft=-1, ybottom=dat_plot2[dat_plot2[,1]==(-1),i], xright=80, ytop=3, density = NULL, angle = 45,
       border = "white",col=colup)
  rect(xleft=-1, ybottom=-2, xright=80, ytop=dat_plot2[dat_plot2[,1]==(-1),i], density = NULL, angle = 45,
       border = "white",col=coldown)
  abline(h=seq(-1.2,2,by=.2),col="gray",lty=2)
  abline(h=dat_plot2[dat_plot2[,1]==(-1),i],col=colz2[5],lwd=2)
  points(dat_plot2[dat_plot2[,1]!=(-1),c(1,i)],col=colz2[5],pch=16,
         main=colnames(dat_plot2)[i],xlab="% Gaps",ylab="Silhouette index",xlim=c(0,72),ylim=c(-.5,.2))
  lines(dat_plot2[,c(1,i)][order(dat_plot2[,1]),],col="black",lwd=3.5)
  lines(dat_plot2[,c(1,i)][order(dat_plot2[,1]),],col=colz2[5],lwd=3)
...
pdf(file=file.path(origin,"figures","figure_2","figure_2_e.pdf"),width=12,height=6)
par(mfrow=c(2,6),mar=c(4,4,2,2))
i=2
...
pdf(file=file.path(origin,"figures","figure_2","figure_2_f.pdf"),width=12,height=6)
par(mfrow=c(2,6),mar=c(4,4,2,2))
i=2
...
pdf(file=file.path(origin,"figures","figure_2","figure_2_g.pdf"),width=12,height=6)
par(mfrow=c(2,6),mar=c(4,4,2,2))
i=2
