...
ix3=res$TraitChoice=="data_2"&res$Obs_or_Spec=="Obs_obs"
...
dat_plotENV <- aggregate(dat_rmse3,by=list(Percent3),FUN=mean,na.rm = TRUE)
...
colz=c("#b2182b","#ef8a62","#fddbc7","#d1e5f0","#67a9cf","#2166ac")
  ...
  pdf(file=file.path(origin,"_2021","Figures","Figure_1","Fig_1_RMSE_zlog.pdf"),width=10,height=8)
      par(mfrow=c(1,1),mar=c(7,7,2,2))
      i=2
      plot(dat_plot2[,c(1,i)],col=colz[i],pch=16,cex=.1,cex.lab=3,cex.axis=3,
           xlab="Missingness [% gaps]",ylab="RMSE",xlim=c(0,110),ylim=c(0,.6))
      ...
      i=1
      for(i in 1:length(trait_rainfor)){
        print(trait_rainfor[i])
        lines(dat_plot2[,1],dat_plot2[,colnames(dat_plot2)==paste0("RMSE_zlog_",trait_rainfor[i])],col=colz[i],lwd=5)
        lines(dat_plot2[,1],dat_plot2[,colnames(dat_plot2)==paste0("RMSE_gap_zlog_",trait_rainfor[i])],col=colz[i],lwd=3,lty=5)
      }  
      ...
      lines(dat_plotENV[,1],dat_plotENV[,colnames(dat_plotENV)=="RMSE_zlog_Total"],col="red",lwd=5)
      lines(dat_plotENV[,1],dat_plotENV[,colnames(dat_plotENV)=="RMSE_gap_zlog_Total"],col="red",lwd=3,lty=5)
      
      rect(xleft = 82,ybottom = 0,xright = 109,ytop = .95,col = "white",border = FALSE)
      level_names=c("Average",trait_rainfor,"All values","Missing only","Envelope")
      legend(83, .6, level_names, col = c("black",colz,"gray","gray","red"),bty = "n",
             text.col = "black", lty = c(1,rep(1,6),1,2), lwd=4,cex=1.3,
             merge = TRUE, bg = "white")  
  dev.off()
  ...
  pdf(file=file.path(origin,"_2021","Figures","Figure_1","Fig_1_RMSE.pdf"),width=10,height=8)
      ...
      i=2
      plot(dat_plot2[,c(1,i)],col=colz[i],pch=16,cex=.1,cex.lab=3,cex.axis=3,
           xlab="Missingness [% gaps]",ylab="RMSE",xlim=c(0,110),ylim=c(0,4))
      abline(h=seq(0,5,by=.5),col="gray",lty=2)
      colnames(dat_plot2)
      lines(dat_plot2[,1],dat_plot2[,colnames(dat_plot2)=="RMSE_Total"],col="black",lwd=5)
      lines(dat_plot2[,1],dat_plot2[,colnames(dat_plot2)=="RMSE_gap_Total"],col="black",lwd=3,lty=5)
      
      i=1
      for(i in 1:length(trait_rainfor)){
        print(trait_rainfor[i])
        lines(dat_plot2[,1],dat_plot2[,colnames(dat_plot2)==paste0("RMSE_",trait_rainfor[i])],col=colz[i],lwd=5)
        lines(dat_plot2[,1],dat_plot2[,colnames(dat_plot2)==paste0("RMSE_gap_",trait_rainfor[i])],col=colz[i],lwd=3,lty=5)
      }  
      ...
      rect(xleft = 82,ybottom = 0,xright = 115,ytop = 4.05,col = "white",border = FALSE)
      level_names=c("Average",trait_rainfor,"All values","Missing only")
      legend(83, 3.5, level_names, col = c("black",colz,"gray","gray"),bty = "n",
             text.col = "black", lty = c(1,rep(1,6),1,2), lwd=4,cex=1.3,
             merge = TRUE, bg = "white")  
  dev.off()
  ...
  pdf(file=file.path(origin,"_2021","Figures","Figure_Sx","Fig_1data2_RMSE_zlog.pdf"),width=10,height=8)
      par(mfrow=c(1,1),mar=c(7,7,2,2))
      i=2
      ...
      lines(dat_plot[,1],dat_plot[,colnames(dat_plot)=="RMSE_gap_zlog_Total"],col="black",lwd=3,lty=5)
      
      i=1
      for(i in 1:length(trait_guido)){
        print(trait_guido[i])
        lines(dat_plot[,1],dat_plot[,colnames(dat_plot)==paste0("RMSE_zlog_",trait_guido[i])],col=colz[i],lwd=5)
        lines(dat_plot[,1],dat_plot[,colnames(dat_plot)==paste0("RMSE_gap_zlog_",trait_guido[i])],col=colz[i],lwd=3,lty=5)
      }  
      ...
      rect(xleft = 82,ybottom = 0,xright = 109,ytop = .95,col = "white",border = FALSE)
      level_names=c("Average",trait_guido,"All values","Missing only")
      legend(83, .6, level_names, col = c("black",colz,"gray","gray"),bty = "n",
             text.col = "black", lty = c(1,rep(1,6),1,2), lwd=4,cex=1.3,
             merge = TRUE, bg = "white")  
  dev.off()
  
  pdf(file=file.path(origin,"_2021","Figures","Figure_Sx","Fig_1data2_RMSE.pdf"),width=10,height=8)
  par(mfrow=c(1,1),mar=c(7,7,2,2))
  i=2
  plot(dat_plot[,c(1,i)],col=colz[i],pch=16,cex=.1,cex.lab=3,cex.axis=3,
       xlab="Missingness [% gaps]",ylab="RMSE",xlim=c(0,110),ylim=c(0,4))
  abline(h=seq(0,5,by=.5),col="gray",lty=2)
  colnames(dat_plot)
  lines(dat_plot[,1],dat_plot[,colnames(dat_plot)=="RMSE_Total"],col="black",lwd=5)
  lines(dat_plot[,1],dat_plot[,colnames(dat_plot)=="RMSE_gap_Total"],col="black",lwd=3,lty=5)
  
  i=1
  for(i in 1:length(trait_guido)){
    print(trait_guido[i])
    try(lines(dat_plot[,1],dat_plot[,colnames(dat_plot)==paste0("RMSE_",trait_guido[i])],col=colz[i],lwd=5))
    try(lines(dat_plot[,1],dat_plot[,colnames(dat_plot)==paste0("RMSE_gap_",trait_guido[i])],col=colz[i],lwd=3,lty=5))
  }  
