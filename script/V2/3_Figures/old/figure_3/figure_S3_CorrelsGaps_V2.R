...
#   for(ts in 1:2){
    ...
    pdf(file=file.path(origin,"_2021","figures","Figure_3","Figure_S3_PearsonGaps.pdf"),width=6,height=8)
    ...
    pdf(file=file.path(origin,"_2021","figures","Figure_3","Figure_S3_Corsd.pdf"),width=6,height=8)
    par(mfrow=c(1,1),mar=c(7,7,1,1))
    ...
    pdf(file=file.path(origin,"_2021","figures","Figure_3","Figure_S3_PearsonGaps_zlog.pdf"),width=6,height=8)
    par(mfrow=c(1,1),mar=c(7,7,1,1))
    ...
    pdf(file=file.path(origin,"_2021","figures","Figure_3","Figure_S3_Corsd_zlog.pdf"),width=6,height=8)
    par(mfrow=c(1,1),mar=c(7,7,1,1))
