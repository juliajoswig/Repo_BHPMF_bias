...
#   for(ts in 1:2){
    ...
    pdf(file=file.path(origin,"_2021","figures","Figure_3","Figure_S3_PearsonGapsENV.pdf"),width=6,height=8)
    par(mfrow=c(1,1),mar=c(7,7,1,1))
    
    Correl_now <- cbind(Percent,abs(Correls2))
    colnames(Correl_now)
    whichcols = which(!duplicated(Correl_now[1,]))
    #whichcols <- whichcols[whichcols!=1]
    colnames(Correl_now)[whichcols ]
    ...
    pdf(file=file.path(origin,"_2021","figures","Figure_3","Figure_S3_CorsdENV.pdf"),width=6,height=8)
    par(mfrow=c(1,1),mar=c(7,7,1,1))
    ...
    pdf(file=file.path(origin,"_2021","figures","Figure_3","Figure_S3_PearsonGaps_zlogENV.pdf"),width=6,height=8)
    par(mfrow=c(1,1),mar=c(7,7,1,1))
    ...
    pdf(file=file.path(origin,"_2021","figures","Figure_3","Figure_S3_Corsd_zlogENV.pdf"),width=6,height=8)
    par(mfrow=c(1,1),mar=c(7,7,1,1))
