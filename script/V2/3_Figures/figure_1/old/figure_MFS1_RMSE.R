...
#select type of transformation (I think)
dat_plot[,colnames(dat_plot)=="RMSE_zlog_Total"]
dat_plot2[,colnames(dat_plot2)=="RMSE_zlog_Total"]
dat_plotENV[,colnames(dat_plot2)=="RMSE_zlog_Total"]
#dat_plot2[,colnames(dat_plot2)=="RMSE_gap_zlog_Total"]
#dat_plotENV[,colnames(dat_plot2)=="RMSE_gap_zlog_Total"]
  ...
  pdf(file=file.path(origin,"_2021","Figures","Figure_1","Fig_1_RMSE_zlog.pdf"),width=10,height=8)
      ...
      for(i in 1:length(trait_names)){
        ...
        lines(dat_plot[,1],dat_plot[,colnames(dat_plot)==paste0("RMSE_gap_zlog_",trait_names[i])],col=colz[i],lwd=3,lty=5)
      }  
  ...
  pdf(file=file.path(origin,"_2021","Figures","Figure_1","Fig_1_RMSE.pdf"),width=10,height=8)
      ...
      for(i in 1:length(trait_names)){
        print(trait_names[i])
        lines(dat_plot2[,1],dat_plot2[,colnames(dat_plot2)==paste0("RMSE_",trait_names[i])],col=colz[i],lwd=5)
        lines(dat_plot2[,1],dat_plot2[,colnames(dat_plot2)==paste0("RMSE_gap_",trait_names[i])],col=colz[i],lwd=3,lty=5)
      }  
      ...
      level_names=c("Average",trait_names,"All values","Missing only")
