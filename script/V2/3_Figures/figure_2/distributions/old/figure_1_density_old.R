...
pdf(file=file.path(origin,"_2021","figures","figure_1","Fig_1_Density.pdf"),width=18,height=4)

{
  ...
  for(t in 1:length(trait_names)){
    ...
    de <- density(res$value_obs[ix_trait],na.rm = T,adjust = 1.5,bw = "SJ")
