...
#  traitRANDOM1 <- traitInfo_obs_zlog[sample(1:nrow(traitInfo_obs_zlog),nrow(traitInfo_obs_zlog)),]
#  traitRANDOM2 <- traitInfo_obs_zlog[sample(1:nrow(traitInfo_obs_zlog),nrow(traitInfo_obs_zlog)),]
#  traitRANDOM3 <- traitInfo_obs_zlog[sample(1:nrow(traitInfo_obs_zlog),nrow(traitInfo_obs_zlog)),]
#  colnames(traitRANDOM1) <- paste0(colnames(traitInfo_obs_zlog),"_RM1")
#  colnames(traitRANDOM2) <- paste0(colnames(traitInfo_obs_zlog),"_RM2")
#  colnames(traitRANDOM3) <- paste0(colnames(traitInfo_obs_zlog),"_RM3")
  traitInfo_obs_zlogCOR <- traitInfo_obs_zlog
#  traitInfo_obs_zlogCOR <- cbind(traitInfo_obs_zlog,traitRANDOM1,traitRANDOM2,traitRANDOM3)
#  traitRANDOM1 <- traitInfo_obs_zlog_sparse[sample(1:nrow(traitInfo_obs_zlog_sparse),nrow(traitInfo_obs_zlog_sparse)),]
#  traitRANDOM2 <- traitInfo_obs_zlog_sparse[sample(1:nrow(traitInfo_obs_zlog_sparse),nrow(traitInfo_obs_zlog_sparse)),]
#  traitRANDOM3 <- traitInfo_obs_zlog_sparse[sample(1:nrow(traitInfo_obs_zlog_sparse),nrow(traitInfo_obs_zlog_sparse)),]
#  colnames(traitRANDOM1) <- paste0(colnames(traitInfo_obs_zlog_sparse),"_RM1")
#  colnames(traitRANDOM2) <- paste0(colnames(traitInfo_obs_zlog_sparse),"_RM2")
#  colnames(traitRANDOM3) <- paste0(colnames(traitInfo_obs_zlog_sparse),"_RM3")
#  traitInfo_obs_zlog_sparseCOR <- cbind(traitInfo_obs_zlog_sparse,traitRANDOM1,traitRANDOM2,traitRANDOM3)
  traitInfo_obs_zlog_sparseCOR <- traitInfo_obs_zlog_sparse
#  traitRANDOM1 <- traitInfo_pred_zlog[sample(1:nrow(traitInfo_pred_zlog),nrow(traitInfo_pred_zlog)),]
#  traitRANDOM2 <- traitInfo_pred_zlog[sample(1:nrow(traitInfo_pred_zlog),nrow(traitInfo_pred_zlog)),]
#  traitRANDOM3 <- traitInfo_pred_zlog[sample(1:nrow(traitInfo_pred_zlog),nrow(traitInfo_pred_zlog)),]
#  colnames(traitRANDOM1) <- paste0(colnames(traitInfo_pred_zlog),"_RM1")
#  colnames(traitRANDOM2) <- paste0(colnames(traitInfo_pred_zlog),"_RM2")
#  colnames(traitRANDOM3) <- paste0(colnames(traitInfo_pred_zlog),"_RM3")
#  traitInfo_pred_zlogCOR <- cbind(traitInfo_pred_zlog,traitRANDOM1,traitRANDOM2,traitRANDOM3)
  ...
  for(t in 1:ncol(traitInfo_obs_zlog_sparse)){
    ...
    ix_trait1 = 1:nrow(traitInfo_obs_zlog_sparse) + 
      ((t-1)*nrow(traitInfo_obs_zlog_sparse)) 
    ...
    for(t1 in 1:ncol(traitInfo_obs_zlog_sparseCOR)){
        for(t in t){
          if(t1!=t){
#            colnm1=paste0(colnames(traitInfo_obs_zlog_sparseCOR)[t],"_from_",colnames(traitInfo_obs_zlog_sparseCOR)[t1],"_RESobs")
#            colnm2=paste0(colnames(traitInfo_obs_zlog_sparseCOR)[t],"_from_",colnames(traitInfo_obs_zlog_sparseCOR)[t1],"_RESpred")
#            colnm3=paste0(colnames(traitInfo_obs_zlog_sparseCOR)[t],"_from_",colnames(traitInfo_obs_zlog_sparseCOR)[t1],"_RESdev")
...
#            points(traitInfo_obs_zlogCOR[,t1],t_lm_obs,col="orange",pch=16)
            
            #HPMF predicted
#            t_lm_pred <- (traitInfo_pred_zlogCOR[,t1]*lm_now$coefficients[2])+lm_now$coefficients[1]
#            points(traitInfo_pred_zlogCOR[,c(t1,t)],pch=1,col="gray")
#            points(traitInfo_pred_zlogCOR[,t1],t_lm_pred,col="hotpink",pch=16,cex=.5)
            
#            t_res_obs <-   (t_lm_obs - traitInfo_pred_zlogCOR[,t])
#            t_res_pred <- (t_lm_pred - traitInfo_pred_zlogCOR[,t])
#            points(traitInfo_obs_zlogCOR[,t1],t_res_obs,col="green",pch=16)
#            points(traitInfo_pred_zlogCOR[,t1],t_res_pred,col="darkgreen",pch=15)
#            boxplot(cbind(abs(t_res_pred),abs(t_res_obs)),col="green",pch=16,ylim=c(0,4),main=colnm1)
