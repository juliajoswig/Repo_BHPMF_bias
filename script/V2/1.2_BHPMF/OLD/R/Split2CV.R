...
for (datasetId in 1 : numDatasets){
    ...
    rm(list = tmp);
    findFolds(zsLogYtrainFactorTree, numFolds, fileName, treeFile, inputDir, -1, traitNames, testFlag); 
    ...
    rm(list = tmp);
    findFolds(zsLogYtrainFactorSpecies, numFolds, fileName, treeFile, inputDir, secondCV, traitNames, testFlag);
    ...
    rm(list = tmp)
    findFolds(zsLogYtrainFactorGenus, numFolds, [filename, int2str(datasetId)], treeFile, inputDir, secondCV, traitNames, testFlag);
    ...
    rm(list = tmp);
    findFolds(zsLogYtrainFactorFamily, numFolds, fileName, treeFile, inputDir, secondCV, traitNames, testFlag);
    ...
    rm(list = tmp);
    findFolds(zsLogYtrainFactorPhylo, numFolds, fileName, treeFile, inputDir, secondCV, traitNames, testFlag);
