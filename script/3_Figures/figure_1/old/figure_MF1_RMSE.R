...
list.files(file.path(origin,"_2021","figures","Figure_1"))
  ...
  pdf(file=file.path(origin,"_2021","figures","Figure_1","Fig_1_RMSE_zlog_.pdf"),width=10,height=8)
  ...
  pdf(file=file.path(origin,"_2021","figures","Figure_1","Fig_1_RMSE_.pdf"),width=10,height=8)
      par(mfrow=c(1,1),mar=c(7,7,2,2))
      i=2
      plot(dat_plot2[,c(1,i)],col=colz[i],pch=16,cex=.1,cex.lab=3,cex.axis=3,
  ...
  pdf(file=file.path(origin,"_2021","figures","Figure_Sx","Fig_1data2_RMSE_zlog_.pdf"),width=10,height=8)
      par(mfrow=c(1,1),mar=c(7,7,2,2))
      i=2
  ...
  pdf(file=file.path(origin,"_2021","figures","Figure_Sx","Fig_1data2_RMSE_.pdf"),width=10,height=8)
  par(mfrow=c(1,1),mar=c(7,7,2,2))
  i=2
  plot(dat_plot[,c(1,i)],col=colz[i],pch=16,cex=.1,cex.lab=3,cex.axis=3,
       xlab="Missingness [% gaps]",ylab="RMSE",xlim=c(0,110),ylim=c(0,4))
