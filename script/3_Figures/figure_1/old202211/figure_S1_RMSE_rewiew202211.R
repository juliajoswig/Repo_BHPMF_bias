...
dev.off()
  pdf(file=file.path(origin,"_2021","Figures","Figure_1","Fig_1_RMSE_review.pdf"),width=15,height=10)
  {
  ...
  plot(dat_plot2[,c(1,i)],col=colz[i],pch=16,cex=.1,cex.lab=3,cex.axis=3,
          ...
          xaxt="n",yaxt="n", main="Total values (TD2td)",cex.main=2.5)
      ...
      #------------------------------TDext Total = all values
      plot(dat_plot2[,c(1,i)],col=colz[i],pch=16,cex=.1,cex.lab=3,cex.axis=3,
           xlab="",ylab="",xlim=c(0,80),ylim=c(0,.6),frame=FALSE,
           xaxt="n",yaxt="n", main="Total values (TD2ext)",cex.main=2.5)
      axis(1,line = 2.5,cex.axis=2)
      axis(1,line=5,at=c(40),labels = "Missingness [% gaps]",tick=FALSE,cex.axis=2)
      axis(2,line = 2.5,cex.axis=2)
      axis(2,line=5,at=.3,labels = "RMSE",tick=FALSE,cex.axis=3)
      ...
      plot(dat_plot2[,c(1,i)],col=colz[i],pch=16,cex=.1,cex.lab=3,cex.axis=3,
           xlab="",ylab="",xlim=c(0,80),ylim=c(0,.6),frame=FALSE,
           xaxt="n",yaxt="n", main="Gaps (TD2td)",cex.main=2.5)
      axis(1,line = 2.5,cex.axis=2)
      axis(1,line=5,at=c(40),labels = "Missingness [% gaps]",tick=FALSE,cex.axis=2)
      axis(2,line = 2.5,cex.axis=2)
      axis(2,line=5,at=.3,labels = "RMSE",tick=FALSE,cex.axis=3)
      ...
      #------------------------------TDext  gap= only missing values
      plot(dat_plot2[,c(1,i)],col=colz[i],pch=16,cex=.1,cex.lab=3,cex.axis=3,
           xlab="",ylab="",xlim=c(0,80),ylim=c(0,.6),frame=FALSE,
           xaxt="n",yaxt="n", main="Gaps (TD2ext)",cex.main=2.5)
      axis(1,line = 2.5,cex.axis=2)
      axis(1,line=5,at=c(40),labels = "Missingness [% gaps]",tick=FALSE,cex.axis=2)
      axis(2,line = 2.5,cex.axis=2)
      axis(2,line=5,at=.3,labels = "RMSE",tick=FALSE,cex.axis=3)
  ...
  pdf(file=file.path(origin,"_2021","Figures","Figure_S1","Fig_1data2_RMSE_zlog_rewiev.pdf"),width=15,height=10)
  {
  layout(matrix(c(1,1,2,2,3,
                  4,4,5,5,6),nrow=2,ncol=5,byrow=TRUE))
  #layout.show(nf)
