...
#   for(ts in 1:2){
  ...
  if(t_choice=="data"){pdf(file=file.path(origin,"figures","Correls","Figure_Pearson.pdf"),width=15,height=8)}
  if(t_choice=="data_2"){pdf(file=file.path(origin,"figures","Correls","Figure_PearsonTD2.pdf"),width=15,height=8)}
  {
