...
Correl_now <- cbind(Percent,abs(Correls))
colnames(Correl_now)
...
if(t_choice=="data"){ pdf(file=file.path(origin,"_2021","figures","Figure_3","Figure_3_PearsonGaps_zlog.pdf"),width=6,height=8)}
if(t_choice=="data"){ pdf(file=file.path(origin,"_2021","figures","Figure_3","Figure_S_PearsonGaps_zlog.pdf"),width=6,height=8)}
{
...
if(t_choice=="data"){pdf(file=file.path(origin,"_2021","figures","Figure_3","Figure_3_Corsd_zlog.pdf"),width=6,height=8)}
if(t_choice=="data_2"){pdf(file=file.path(origin,"_2021","figures","Figure_3","Figure_S_Corsd_zlog.pdf"),width=6,height=8)}
...
#   for(ts in 1:2){
  ...
  if(t_choice=="data"){    pdf(file=file.path(origin,"_2021","figures","Figure_4","Figure_4_Pearson.pdf"),width=15,height=8)}
  if(t_choice=="data_2"){    pdf(file=file.path(origin,"_2021","figures","Figure_4","Figure_S_Pearson.pdf"),width=15,height=8)}
  ...
  dev.off()
    ...
    if(t_choice=="data"){pdf(file=file.path(origin,"_2021","figures","Figure_3","Figure_3_Corsd.pdf"),width=6,height=8)}
    if(t_choice=="data_2"){pdf(file=file.path(origin,"_2021","figures","Figure_3","Figure_S_Corsd.pdf"),width=6,height=8)}
