...
#   for(ts in 1:2){
    ...
    pdf(file=file.path(origin,"_2021","figures","Figure_3","Figure_3_PearsonGapsENV.pdf"),width=6,height=8)
    ...
    pdf(file=file.path(origin,"_2021","figures","Figure_3","Figure_3_CorsdENV.pdf"),width=6,height=8)
    par(mfrow=c(1,1),mar=c(7,7,1,1))
    ...
    pdf(file=file.path(origin,"_2021","figures","Figure_3","Figure_3_PearsonGaps_zlogENV.pdf"),width=6,height=8)
    par(mfrow=c(1,1),mar=c(7,7,1,1))
    ...
    pdf(file=file.path(origin,"_2021","figures","Figure_3","Figure_3_Corsd_zlogENV.pdf"),width=6,height=8)
    par(mfrow=c(1,1),mar=c(7,7,1,1))
