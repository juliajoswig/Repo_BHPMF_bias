...
t=2
  ...
  library(fmsb)
pdf(file=file.path(origin,"_2021","figures","Figure_6","Figure_spider_meanT2.pdf"))#,width = 11,height=8
{
...
dev.off()  
 ...
 pdf(file=file.path(origin,"_2021","figures","Figure_4","Figure_4_3.pdf"),width = 11,height=8)
  ...
  for(t in 1:5){
    ...
    text(2.5,5,labels = "x: trait value (mean)",cex=2)
