...
colnames(m1) <- c("TD","TD_sparse","TD_td","Envelope","TD_env","Env_sparse")
colnames(m2) <-  c("TD","TD_sparse","TD_td","Envelope","TD_env","Env_sparse")
colnames(m3) <-  c("TD","TD_sparse","TD_td","Envelope","TD_env","Env_sparse")
colnames(m4) <-  c("TD","TD_sparse","TD_td","Envelope","TD_env","Env_sparse")
...
if(t_choice=="data"){
pdf(file=file.path(origin,"_2021","figures","figure_2","Fig_2_Mean.pdf"),width=18,height=4)
}
if(t_choice=="data_2"){
  pdf(file=file.path(origin,"_2021","figures","figure_2","Fig_S2_Mean.pdf"),width=18,height=4)
}
  {
  par(mfrow=c(1,length(trait_names)),mar=c(9,6,3,1))
