...
pdf(file=file.path(origin,"_2021","figures","Figure_Supplementary","fig_1distribution.pdf"),width=12,height=8)
...
for(t in 1:length(traitInfo_obsTD)){
  ...
  boxplot(dens_datTD,dens_datENV[ix],
          ...
          dens_datENV[ix&taxInfo_obsENV$Clade%in%taxInfo_obsTD$Clade],col=colz,yaxt="n",main=nme,
          cex.main=2,xlab=units[t])
