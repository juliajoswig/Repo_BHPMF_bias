...
pdf(file=file.path(origin,"_2021","figures","Figure_1","Fig_1_ValueWiseENV.pdf"),width=10,height =8)
...
pdf(file=file.path(origin,"_2021","figures","figure_1","Fig_1_ValueWiseGAPSonlyENV.pdf"),width=10,height =8)
par(mfrow=c(1,1),mar=c(4,4,2,2))
par(mfrow=c(1,7),mar=c(0,6,0,0))
