...
#   for(ts in 1:2){
    ...
    colnames(Correl_now)
    Correl_now <- Correl_now[,-c(3,3,4,5,6,7,8,9,12,13,16,17,21)]
    colnames(Correl_now)
    ...
    legend(x=35,y = 1.25,colnames(Correl_agg)[2:ncol(Correl_agg)],col=colz[1:ncol(Correl_agg)],cex=1,lwd=2,lty=ltys,
           bty = "n",
           border = "white")    
    ...
    legend(x=83,y = .95,colnames(Correl_now)[2:ncol(Correl_now)],col=colz[1:ncol(Correl_now)],cex=1,lwd=3,lty=ltys,
           bty = "n",
           border = "white")    
