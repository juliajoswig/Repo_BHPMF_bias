...
colz_solid=c(rgb(103/255,169/255,207/255),rgb(239/255,138/255,98/255))
  ...
  pdf(file=file.path(origin,"_2021","figures","Figure_3",paste0("Figure_S3_lm",missingness[m],"_2_zlog.pdf")),width=20,height=8)
  {
    ...
    par(mar=c(4,0,4,0))
    layout(mat = matrix(c(1:6,1:6,1:6,
                          1:6,
    ...
    for(t in 1:5){
      ...
      for(t2 in 1:4){
        ...
        bxplENV=cbind(bxplENV,abs(bxpl_tot_opENV[[t]][,c(1,5)+(t2-1)]))
      }
      bxpl <- bxpl[,-1]
      bxplENV <- bxplENV[,-1]
    ...
    legend(3, 14, trait_names[1], col = colzTRAITS[1], pch = 15, cex = 3,bty = "n")
    legend(3.9,14, trait_names[2], col = colzTRAITS[2], pch = 15, cex = 3,bty = "n")
    legend(6, 14, trait_names[3], col = colzTRAITS[3], pch = 15, cex = 3,bty = "n")
    legend(7.5, 14, trait_names[4], col = colzTRAITS[4], pch = 15, cex = 3,bty = "n")
    legend(8.5, 14, trait_names[5], col = colzTRAITS[5], pch = 15, cex = 3,bty = "n")
